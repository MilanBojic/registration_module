...
import static com.pushtorefresh.storio3.internal.InternalQueries.*;
 ...
 * Thread-safe.
 */
public class StorioWrapperDB extends StorIOSQLite {
    ...
    /**
     * Implementation of {@link com.pushtorefresh.storio3.sqlite.StorIOSQLite.LowLevel}.
     */
    @NonNull
    private final LowLevel lowLevel;

    protected StorioWrapperDB(
        ...
        lowLevel = new StorioWrapperDB.LowLevelImpl(typeMappingFinder);
    }
    ...
    /**
     * Creates new builder for {@link com.pushtorefresh.storio3.sqlite.impl.DefaultStorIOSQLite}.
     *
     * @return non-null instance of {@link com.pushtorefresh.storio3.sqlite.impl.DefaultStorIOSQLite.Builder}.
     */
    @NonNull
    public static StorioWrapperDB.Builder builder() {
        return new StorioWrapperDB.Builder();
    }

    /**
     * Builder for {@link com.pushtorefresh.storio3.sqlite.impl.DefaultStorIOSQLite}.
     */
    public static final class Builder {

        /**
         * Please use {@link com.pushtorefresh.storio3.sqlite.impl.DefaultStorIOSQLite#builder()} instead of this.
         */
        Builder() {
        }
         ...
         */
        @NonNull
        public StorioWrapperDB.CompleteBuilder sqliteOpenHelper(@NonNull SQLiteOpenHelper sqliteOpenHelper) {
            checkNotNull(sqliteOpenHelper, "Please specify SQLiteOpenHelper instance");
            return new StorioWrapperDB.CompleteBuilder(sqliteOpenHelper);
        }
    }

    /**
     * Compile-time safe part of builder for {@link com.pushtorefresh.storio3.sqlite.impl.DefaultStorIOSQLite}.
     */
    public static final class CompleteBuilder {
         ...
         */
        @NonNull
        public <T> StorioWrapperDB.CompleteBuilder addTypeMapping(@NonNull Class<T> type, @NonNull SQLiteTypeMapping<T> typeMapping) {
         ...
         */
        @NonNull
        public StorioWrapperDB.CompleteBuilder typeMappingFinder(@NonNull TypeMappingFinder typeMappingFinder) {
         ...
         */
        @NonNull
        public StorioWrapperDB.CompleteBuilder defaultRxScheduler(@Nullable Scheduler defaultRxScheduler) {
            this.defaultRxScheduler = defaultRxScheduler;
            return this;
        }
         ...
         */
        @NonNull
        public StorioWrapperDB.CompleteBuilder addInterceptor(@NonNull Interceptor interceptor) {
            interceptors.add(interceptor);
            return this;
        }

        /**
         * Builds {@link com.pushtorefresh.storio3.sqlite.impl.DefaultStorIOSQLite} instance with required params.
         *
         * @return new {@link com.pushtorefresh.storio3.sqlite.impl.DefaultStorIOSQLite} instance.
         */
        @NonNull
        public StorioWrapperDB build() {
            ...
            return new StorioWrapperDB(sqLiteOpenHelper, typeMappingFinder, defaultRxScheduler, interceptors);
        }
    }
    ...
    protected class LowLevelImpl extends LowLevel {
         ...
         * To send it use {@link com.pushtorefresh.storio3.sqlite.impl.DefaultStorIOSQLite#executeSQL()} instead.
         *
         ...
         * or use {@link com.pushtorefresh.storio3.sqlite.impl.DefaultStorIOSQLite#put()} instead.
         *
         ...
         * Notice: Direct call of this method will not trigger notification,
         * you should do it manually with {@link #notifyAboutChanges(Changes)}
         * or use {@link com.pushtorefresh.storio3.sqlite.impl.DefaultStorIOSQLite#delete()} instead.
         *
